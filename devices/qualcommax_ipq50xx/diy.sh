...
git_clone_path main https://github.com/openwrt/openwrt package/boot/uboot-envtools package/firmware/ipq-wifi package/kernel/mac80211 package/kernel/qca-ssdk
